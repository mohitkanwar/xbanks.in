...
var AccountsService = /** @class */ (function () {
    ...
    AccountsService.prototype.getSavingsAccounts = function () {
        return this.http.get(this.backendApis.getAccountsAPI());
    };
    AccountsService.prototype.getDepositAccounts = function () {
        return this.http.get(this.backendApis.getDepositAccountsAPI());
    };
    AccountsService.prototype.getLoanAccounts = function () {
        return this.http.get(this.backendApis.getLoanAccountsAPI());
    };
    AccountsService.prototype.getCardAccounts = function () {
...
var PortfolioSummaryComponent = /** @class */ (function () {
    ...
    PortfolioSummaryComponent.ctorParameters = function () { return [
...
var TransactionsSummaryComponent = /** @class */ (function () {
    ...
    TransactionsSummaryComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    TransactionsSummaryComponent.ctorParameters = function () { return [
...
var ExampleHttpDatabase = /** @class */ (function () {
    ...
    ExampleHttpDatabase.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
        ...
        if (loginForm.valid) {
            ...
            this.loginService.login(user).subscribe(function (response) {
                if (response.status.status === 'SUCCESS') {
                    ...
                    _this.notificationService.sendNotification('User login Error!');
                }
            }, function (error) {
                if (error.status === 401) {
                    _this.notificationService.sendNotification('Invalid Credentials!');
                }
                else {
                    _this.notificationService.sendNotification('An error occurred!');
                }
                console.log(error);
            });
        }
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (user) {
        ...
        return this.http.post(this.backendAPIs.getLogintAPI(), user, { headers: headers });
    };
    LoginService.prototype.logout = function () {
        ...
        return this.http.post(this.backendAPIs.getLogOutAPI(), null, { headers: headers });
    };
...
var PreLoginComponent = /** @class */ (function () {
    function PreLoginComponent() {
    }
    PreLoginComponent.prototype.ngOnInit = function () {
    };
...
var ConfirmationDialogueButtons = /** @class */ (function () {
    ...
    ConfirmationDialogueButtons.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String }
    ]; };
...
var ConfirmationDialogueComponent = /** @class */ (function () {
    ...
    ConfirmationDialogueComponent.ctorParameters = function () { return [
...
var ExpandableListComponent = /** @class */ (function () {
    ...
    ExpandableListComponent.ctorParameters = function () { return [
...
var TopFixedBarComponent = /** @class */ (function () {
    ...
    TopFixedBarComponent.prototype.isAuthenticated = function () {
        return this.loginService.isAuthenticated();
    };
    TopFixedBarComponent.ctorParameters = function () { return [
...
var BackendAPIService = /** @class */ (function () {
    ...
    BackendAPIService.prototype.getBaseUrl = function () {
    ...
    BackendAPIService.prototype.getAccountsAPI = function () {
        return this.getBaseUrl() + 'user/products/accounts';
    };
    BackendAPIService.prototype.getDepositAccountsAPI = function () {
        return this.getBaseUrl() + 'user/products/deposits';
    };
    BackendAPIService.prototype.getLoanAccountsAPI = function () {
        return this.getBaseUrl() + 'user/products/loans';
    };
    BackendAPIService.prototype.getCardsAccountsAPI = function () {
        return this.getBaseUrl() + 'user/products/cards';
    };
    BackendAPIService.prototype.getCorporatesAPI = function () {
        return this.getBaseUrl() + 'corporates/';
    };
    BackendAPIService.prototype.getLogintAPI = function () {
        return this.getBaseUrl() + 'auth/login';
    };
    BackendAPIService.prototype.getLogOutAPI = function () {
        return this.getBaseUrl() + 'logout';
    };
    BackendAPIService.prototype.getInventoryListAPI = function (pageSize, pageNumber) {
        return this.getBaseUrl() +
            'inventory/list' + '?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&sortBy=id';
    };
    BackendAPIService.prototype.getUpdateInventoryListAPI = function (companyName, medicineName) {
        return this.getBaseUrl() +
            'inventory/update/' + companyName + '/' + medicineName + '/';
    };
    BackendAPIService.prototype.getSearchInventoryListAPI = function (searchCriteria) {
        return this.getBaseUrl() +
